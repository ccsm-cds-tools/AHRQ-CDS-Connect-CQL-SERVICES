...
import { get as _get } from './libraries-loader';
...
function load(pathToFolder) {
  ...
  for (const fileName of readdirSync(pathToFolder)) {
    ...
    // TODO: Else look for an apply element on json
    // NOTE: You can either have cards and cql elements, or apply (look for cards and cql elements first)
